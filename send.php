...
if(!$db) {
  ...
  $sql_details="INSERT INTO sent_information (id,user_id,description,incident_type,latitude,longitude,image_name,date_sent,status) VALUES ('$my_id',0,'$description','$incident_type','$latitude','$longitude','$image_name','$current_date','Pending')";
