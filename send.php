...
if(!$db) {
  ...
  $sql_details="INSERT INTO upload (x_coordinate,y_coordinate,geom,image_name,type) VALUES ('$x_coordinate','$y_coordinate',ST_SetSRID(ST_MakePoint($longitude, $latitude), 4326),'$image','$type')";
